---
title: Gain real-time insights with Request Logging & Profiling UIs
...
enables new introspectability from code where you can now to tap in to inspect & debug when each diagnostic event occurs