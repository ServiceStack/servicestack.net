  ...
  <div class="py-4 mx-auto flex justify-between items-center max-w-screen-lg">
    <div class="mx-auto text-center">
      ...
      <div>
        ...
        <span class="text-sm">Claude 4.6 Sonnet</span>
      </div>
    </div>
    <div class="mx-auto text-center">
      ...
      <div>
        ...
        <span class="text-sm">Gemini 3.1 Pro</span>
      </div>
    </div>
    <div class="mx-auto text-center">
      ...
      <div>
        ...
        <span class="text-sm">Kimi K2.6 (1T)</span>
      </div>
    </div>
    <div class="mx-auto text-center">
      ...
      <div>
        ...
        <span class="text-sm">Qwen3.6 Plus (396B)</span>
      </div>
    </div>
    <div class="mx-auto text-center">
