...
Start an OpenAI `/v1/chat/completions` server and UI on port **8000**:
...
in in `~/.llms/ui.json` where you can configure your preferred system prompts and other defaults.
...
To quickly and easily make use of AI Responses, **Copy Code** icons are readily available on all messages
and code blocks.
